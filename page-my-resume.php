...
<div class="page-banner">
  ...
  <div class="container container--narrow page-section">
    ...
    <?php
      $myResumeExperience = new WP_Query(array(
        'post_type' => 'resume'
      ));
      while ($myResumeExperience->have_posts()) {
          $myResumeExperience->the_post(); ?>
       
          <h2 class="headline headline--small-plus-resume t-left"><?php echo '<strong>'. get_field('experience_position').'</strong>';
            echo ', ';
            the_field('experience_duration'); ?></h2>
